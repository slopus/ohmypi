...
const TYPE_PATTERN = /\b(?:Array|Boolean|Error|Map|Number|Promise|Record|Set|String|unknown|void)\b/g;
...
function commentIndex(line: string, lang: string): number {
  if (lang === "python" || lang === "ruby" || lang === "bash" || lang === "sh" || lang === "shell" || lang === "zsh") {
    return line.indexOf("#");
  }
