...
// Prompt added: a leading Rig/Sonnet identity and AGENTS.md naming. Prompt removed: unsupported
// auto-memory, Claude Code help/product and /fast text, plus guidance that calls Agent with
// Claude-only subagent_type values. Claude's system-reminder and hook instructions are retained.
...
import { claudeSonnet5Prompt } from "./claude/prompt.js";
import { createClaudeProfileTools } from "./impl/profileTools.js";
import { modelAnthropicSonnet5 } from "../providers/models.js";

export const claudeAnthropicSonnet5Profile = createModelProfile({
    providerType: "claude",
    vendor: "anthropic",
    model: modelAnthropicSonnet5,
    imageProfile: "claude",
    toolProfile: "claude",
    tools: createClaudeProfileTools("claude-sonnet-5"),
    prompt: claudeSonnet5Prompt,
    wireMode: "claude-agent-sdk",
    wireModelId: "sonnet[1m]",
