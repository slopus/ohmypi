...
- Profile: [claude-opus-4-8.ts](./claude-opus-4-8.ts)
...
- Requested model: `opus[1m]`; captured wire model: `claude-opus-4-8`
- Capture metadata: [claude-opus-4-8.capture.json](./claude/claude-opus-4-8.capture.json)
...
The untouched capture is [claude-opus-4-8.golden.md](./claude/claude-opus-4-8.golden.md), the prompt Rig sends is [claude-opus-4-8.md](./claude/claude-opus-4-8.md), and the standalone diff is [claude-opus-4-8.patch](./claude/claude-opus-4-8.patch).
...
The official definitions are [claude-opus-4-8.tools.golden.json](./claude/claude-opus-4-8.tools.golden.json), Rig's definitions are [claude-opus-4-8.tools.json](./claude/claude-opus-4-8.tools.json), and the standalone diff is [claude-opus-4-8.tools.patch](./claude/claude-opus-4-8.tools.patch).
...
````diff
diff --git a/claude-opus-4-8.golden.md b/claude-opus-4-8.md
index 3e61c4a..126b29e 100644
--- a/claude-opus-4-8.golden.md
+++ b/claude-opus-4-8.md
@@ -1,4 +1,4 @@
-
...
@@ -14,29 +14,6 @@ Write code that reads like the surrounding code: match its comment density, nami
·
...
@@ -47,8 +24,6 @@ You have been invoked in the following environment:
...
````diff
diff --git a/claude-opus-4-8.tools.golden.json b/claude-opus-4-8.tools.json
index 26f27ac..626adea 100644
--- a/claude-opus-4-8.tools.golden.json
+++ b/claude-opus-4-8.tools.json
@@ -1,56 +1,89 @@
 [
   {
     "name": "Agent",
