...
export const followup_task = {
    ...
    parameters: Type.Object({ "target": Type.String({"description":"Agent id or canonical task name to send a follow-up task to (from spawn_agent)."}), "message": Type.String({"description":"Message text to send to the target agent.","encrypted":true}) }, {"additionalProperties":false}),
