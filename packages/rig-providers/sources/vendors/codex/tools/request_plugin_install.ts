...
export const request_plugin_install = {
    ...
    parameters: Type.Object({ "plugin_id": Type.String({"description":"The parenthesized plugin ID from the `<recommended_plugins>` list."}), "suggest_reason": Type.String({"description":"Concise one-line user-facing reason why this plugin can help with the current request."}) }, {"additionalProperties":false}),
